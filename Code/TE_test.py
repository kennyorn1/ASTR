...
from noisy_regressor import (
    Nosiy_NN_regressor,
    Semisupervised_Nosiy_NN_regressor,
    lstm_l2_network,
    lstm_network,
)
...
data1 = scio.loadmat(father_path + "/TE/d00.mat")["data"].T
data2 = scio.loadmat("./TE/d00_te.mat")["data"].T
...
test_index = np.random.choice(
    list(set(list(np.arange(1460))) - set(train_index)), 960, replace=False
)
